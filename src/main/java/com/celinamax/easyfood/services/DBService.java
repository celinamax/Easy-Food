...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p9 = new Produto(null, "Abajur", 180.00);	
		Produto p10 = new Produto(null, "Pendente", 90.00);	
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "celinamax01@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("32165055", "991137655"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "celinamax@outlook.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
